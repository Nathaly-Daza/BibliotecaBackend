...
Route::middleware(['auth:sanctum', 'check.token.expiry'])->group(function () {
    ...
    Route::get('/projects/{use_id}/spaces/{id}', [SpaceController::class, 'indexProject']);
    ...
    Route::Resource('profesionals' . URL, UsersController::class)->names('profesionals')->parameter('', 'profesionals');
